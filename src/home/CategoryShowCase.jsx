        ...
        <div className="section-header">
          ...
          <div className="course-filter-group">
            <ul className="lab-ul">
              ...
              <li onClick={() => filteredItem("Shoes")}>Shoes</li>
              <li onClick={() => filteredItem("Bags")}>Bags</li>
              <li onClick={() => filteredItem("Phones")}>Phones</li>
              <li onClick={() => filteredItem("Beauty")}>Beauty</li>
            </ul>
          </div>
        </div>
