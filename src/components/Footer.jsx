...
const title = "About Sajad";
const desc =
  "my name is sajad i'm frontend developer i love to code and make website i would be glad to work with a team";
...
const addressList = [
  ...
  },
  {
    ...
    text: "  +98 0916 514 2066",
  },
  {
    iconName: "icofont-envelope",
    text: "  sajad.hardani188@gmail.com",
  },
];
  ...
  <div className="footer-bottom">
    <div className="container">
      <div className="section-wrapper">
        <p>&copy; 2023 <Link to="/">Shop Cart </Link> Designed by <a href="/"> Sajad hardani </a> </p>
